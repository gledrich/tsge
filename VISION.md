...
*   **Entity Component System (ECS) (In Progress):** Transitioned from strict inheritance to a composition-based model. Core data (position, velocity, etc.) moved to `TransformComponent` and `PhysicsComponent`.
